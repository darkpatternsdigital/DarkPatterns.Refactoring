...
public class MustRefactorAnalyzer : DiagnosticAnalyzer
{
    public const string DiagnosticId = "DPDREF03";

    private static readonly LocalizableString Title = new LocalizableResourceString(nameof(Resources.MustRefactorTitle), Resources.ResourceManager, typeof(Resources));
    private static readonly LocalizableString MessageFormat = new LocalizableResourceString(nameof(Resources.MustRefactorMessageFormat), Resources.ResourceManager, typeof(Resources));
    private static readonly LocalizableString Description = new LocalizableResourceString(nameof(Resources.MustRefactorDescription), Resources.ResourceManager, typeof(Resources));
    ...
    {
        var plannedRemoval = context.Symbol.FindAttribute<PlannedRefactorAttribute>(context.ReportDiagnostic);
